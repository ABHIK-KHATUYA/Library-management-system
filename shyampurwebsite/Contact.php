...
<body>
	...
	<div id="templatemo_header_panel">
    	<div id="templatemo_title_section">
				<h1>SSM LIBRARY</h1><br>
	  Increase your knowledge</div>
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <h3 style="color:DarkBlue;"> For any quary :</h3>
                    
                    <div class="post_body">
                     <p style="font-size:13px"><b>   Shyampur Siddheswari Mahavidyalaya<br><br>Ajodhya, Howrah, West Bengal, PIN - 711312<br><br>Telephone & FAX: 03214-261221.<br><br>Email:ssmahavidyalaya@gmail.com<br><br>
                </div>
