        ...
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <div class="templatemo_post">
                    ...
                    <div class="post_body">
                    <h3 style="color:DarkRed;"> Admission to Library :</h3>
                    <p style="font-size:14px"><b>Students are allowed to library only on production of their authorized/valid Identity Cards.</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Circulation Issue System :</h3>
                    <p style="font-size:14px"><b>Books will be issued on presentation of the library card. Students are instructed to check the books while borrowing and they will be responsible for any type of damage or mutilation noticed at the time of return.</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Overdue Charges :</h3>
                    <p style="font-size:14px"><b>Materials borrowed should be returned on or before the due date stamped, if returned late overdue fine will be charged for the delayed period.</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Book Lost :</h3>
                    <p style="font-size:14px"><b>If the books are lost, Then the borrower shall replace the books of the same edition or latest edition or pay double cost of the book after getting permission from the librarian.</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Care of library borrower cards :</h3>
                    <p style="font-size:14px"><b>Take special care to maintain the library borrower cards. Do not fold, alter entries made on the cards, Members are responsible for the entire set of library borrower card issued to them.</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Loss of cards :</h3>
                    <p style="font-size:14px"><b>Loss of borrower card should be reported to the librarian. Duplicate card may be issued against formal application and fine.

</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Validity of cards :</h3>
                    <p style="font-size:14px"><b>Library Lending cards and Reference Cards are valid for current academic year to access library facilities At the end of the academic year lending cards and reference cards shall be returned to the library.

</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Library Hours :</h3>
                    <p style="font-size:14px"><b>Monday to Saturday : 10:00 AM - 4:00 PM <br><br>Sunday and Holidays : Closed

</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Circulation Timing :</h3>
                    <p style="font-size:14px"><b>Monday to Saturday : 10:30 AM - 3:30 PM</b></p>
                    <br>
                    <h3 style="color:DarkRed;"> Reading Room Timing :</h3>
                    <p style="font-size:14px"><b>Monday to Saturday : 10:30 AM - 3:30 PM</b></p>
                    <br>
                    </div>
                </div>
	...
	<div id="templatemo_bottom_panel">
    	<div id="templatemo_bottom_section">
            ...
            <div class="templatemo_bottom_section_content">
                ...
                <a href="http://validator.w3.org/check?uri=referer"><img style="border:0;width:88px;height:31px" src="http://www.w3.org/Icons/valid-xhtml10" alt="" width="88" height="31" vspace="8" border="0" /></a>
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="" vspace="8" border="0" /></a> 
          </div>
